        ...
        <div id="main-container" class="container-fluid vh-100 d-flex flex-column overflow-hidden" style="margin: 0; padding: 0;">
            ...
            <nav class="navbar navbar-expand bg-body-secondary">
                <div class="container-fluid px-5">
                    <span class="navbar-brand mb-0 h1 fs-2"><i class="fa-solid fa-gamepad"></i>Staem</span>
            ...
            <main class="d-flex h-100">
                <section class="w-25 h-100 d-flex flex-column container w-25 border-end border-3 p-0">
                  ...
                  <div class="list-group list-group-flush h-100 overflow-scroll">
                    <button class="list-group-item list-group-item-action">Game 1</button>
                    <button class="list-group-item list-group-item-action">Game 2</button>
                    <button class="list-group-item list-group-item-action">Game 3</button>
                  </div>
                </section>
                    ...
                    <div class="d-flex h-25">
                      <div class="h-100 w-75">
                        ...
                        <p class="text-body-secondary text-truncate">
                          Sed imperdiet nunc at ligula ultrices viverra.
                          Donec aliquam id arcu vitae consectetur. Donec rutrum nisi ut nisl consectetur,
                          hendrerit interdum dolor efficitur. Pellentesque sollicitudin,
                          lectus eget porttitor tempor, metus nisi semper sem, id elementum tortor urna ac sem. 
                          Proin vel auctor nulla, et ullamcorper tellus. Phasellus porta tellus quis vulputate maximus.
                          Duis lobortis massa in mi molestie porta.
                        </p>
                      </div>
                    ...
                    <div class="w-100 d-flex mb-3 justify-content-around">
                      <div class="card h-100 m-3 border bg-body-secondary">
                        <div class="card-body">
                          ...
                          <h1 class="card-text text-primary">5.3 Million</h1>
                      ...
                      <div class="card h-100 m-3 border bg-body-secondary">
                        <div class="card-body">
                          ...
                          <h1 class="card-text text-primary">3.2 Thousand</h1>
                      ...
                      <div class="card h-100 m-3 border bg-body-secondary">
                        <div class="card-body">
                          ...
                          <h1 class="card-text text-primary">12.4 Million $</h1>
