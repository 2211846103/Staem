...
<html>
    <head>
        ...
        <!--Other-->
        <title>Game details - Staem</title>
    </head>
    <body>
        <!--Main Container-->
                ...
                <div class="container d-flex justify-content-between mb-4">
                  ...
                  <form class="w-50">
                    ...
                    <div class="d-flex mb-2">
                      <textarea type="text" class="form-control me-4"></textarea>
                ...
                <div class="list-group mb-5">
                    ...
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between">
                            <span class="text-secondary h4">mohamed zinjar</span>
                            <span>2024-12-24</span>
                        </div>
                        <div>Great experience! Really enjoying playing this game.</div>
                    </div>
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between">
                            <span class="text-secondary h4">tareq</span>
                    ...
                    <div class="list-group-item">
                        <div class="d-flex justify-content-between">
                            <span class="text-secondary h4">rajab&awsem</span>
                            <span>2024-12-22</span>
                        </div>
                        <div>Excellent gameplay!</div>
                    </div>
                </div>
            </main>
        </div>
